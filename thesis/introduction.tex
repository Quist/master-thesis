...
In addition to network limitations, other factors may also restrict the
communication for military units. These are discussed in the next section.
...
Research is the systematic investigation of how to find answers to a specific problem.
