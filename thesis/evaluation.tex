...
in the NFFI format. \Cref{table-nffi-http-requests} shows the HTTP messages
...
\label{table-nffi-http-requests}
\end{table}
...
computer while the Web service is deployed in a Glassfish 4 application server
on another computer. The specifications of the machines used in the testing are
listed in \cref{table-machines}.
...
\end{tabularx}
\caption{The machines involved in the testing}
...
and the proxy retransmission mechanisms were able to continue transmission when
...
This type of communication is characterized by its moderate data rate and high delay.
