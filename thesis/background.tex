...
do not need to deal with this themselves.
...
stream and deliver it to the destination application.
...
congestion control may result in drastic unfairness if an \gls{udp} stream are
