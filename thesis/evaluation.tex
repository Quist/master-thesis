...
three aspects of DIL, \textit{disconnected, intermittent and limited.}
...
average response time. Furthermore we can observe that the default solution without proxies has the best performance in this unlimted network. 
