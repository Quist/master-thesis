...
network. \Cref{table:function-test-packets-nffi} and
...
\begin{itemize}
    ...
    slightly longer average RTT. The resason for this can be the time used to
...
Another consistent trend is that the CoAP proxy struggle with large messages in
