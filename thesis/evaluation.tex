...
CoAP has an almost identical performance, while AMQP has significant longer
...
between the nodes in the network. LOS has high data rate, low delay and zero error.
...
Compared to WiFi 1, we see that all response times have increased
