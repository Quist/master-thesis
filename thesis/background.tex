...
this thesis. Furthermore we will discuss available approaches to creating a
HTTP-proxy.
...
\section{Proxies}
Presenter ulike løsninger for proxies.
...
\begin{table}
    ...
    Build from scract & Time consuming, complex.       \\ \hline
