...
chararistics as can been seen in \cref{figure:military-networks}. At the highest level,
there are fixed infrastructure and a relatively static users. At the lower levels, there are fewer units, but they are much more dynamic. The lower level is called tactical networks which is discussed in the next paragraph.
