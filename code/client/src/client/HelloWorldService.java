 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://server/", wsdlLocation = "file:///home/joakim/IdeaProjects/testclient2/src/client/test.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:///home/joakim/IdeaProjects/testclient2/src/client/test.wsdl");
