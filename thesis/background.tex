...
must occur on the top of the network layer. Of this follows that we will
...
we're investigating in this thesis. The protocols has been selected because of
...
The remaining protocols discussed in the next section all use either \gls{tcp}
or \gls{udp} as their transport protocol.
